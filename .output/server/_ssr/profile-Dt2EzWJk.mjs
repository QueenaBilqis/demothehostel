...
import { i as useLanguage, r as useBookings } from "./store-DX9pURiM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/profile-Dt2EzWJk.js
		...
		activeModal && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: activeModal === "personal" ? t.personalTitle : activeModal === "payment" ? t.paymentTitle : activeModal === "language" ? t.langTitle : t.helpTitle
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					activeModal === "payment" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col gap-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					activeModal === "help" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col gap-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "bg-primary/10 border border-primary/20 p-5 rounded-2xl flex flex-col items-center text-center",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
									name: "support_agent",
									className: "text-[42px] text-primary mb-2"
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: () => setActiveModal(null),
									className: "mt-4 bg-primary text-primary-foreground font-bold px-6 py-2.5 rounded-xl shadow-sm active:scale-95 transition-transform text-[13px]",
									children: t.chat
								})
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								onClick: () => setActiveModal(null),
								className: `flex items-center justify-between p-4 ${i !== 0 ? "border-t border-border" : ""} active:bg-secondary transition-colors`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
