import { t as Route } from "./hostels._id-BPLf07Hr.js";
...
//#endregion
//#region src/components/LeafletMap.tsx
function LeafletMap({ hostel }) {
	...
	if (!isClient || !L || !MapContainer) return /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-secondary animate-pulse" });
	const position = {
