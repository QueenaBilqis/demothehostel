import { t as HOSTELS } from "./hostels-CMsqgrCR.js";
import { n as MobileFrame, t as Icon } from "./MobileFrame-u4Sg7FL7.js";
import { t as HostelCard } from "./HostelCard-VHrVfz4K.js";
	...
	return /* @__PURE__ */ jsxs(MobileFrame, { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/30 via-black/10 to-background" }),
				/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [filteredHostels.map((h) => /* @__PURE__ */ jsx(HostelCard, { h }, h.id)), filteredHostels.length === 0 && /* @__PURE__ */ jsx("div", {
