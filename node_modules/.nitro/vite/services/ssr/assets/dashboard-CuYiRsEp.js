import { t as Icon } from "./MobileFrame-u4Sg7FL7.js";
import { t as useAuth } from "./auth-DfkR6RoP.js";
import { t as api } from "./api-BEiVPuR3.js";
import { n as formatCurrency } from "./store-qnqdex7O.js";
...
function Dashboard() {
	...
	if (loading) return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "h-24 bg-card rounded-2xl" }),
				/* @__PURE__ */ jsx("div", { className: "h-24 bg-card rounded-2xl" }),
				/* @__PURE__ */ jsx("div", { className: "h-24 bg-card rounded-2xl" }),
				/* @__PURE__ */ jsx("div", { className: "h-24 bg-card rounded-2xl" })
			]
		}), /* @__PURE__ */ jsx("div", { className: "h-64 bg-card rounded-2xl" })]
	});
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [bookings.slice(0, 5).map((b) => /* @__PURE__ */ jsxs("div", {
                  ...
                  ${b.status === "completed" ? "bg-green-500/10 text-green-600" : b.status === "cancelled" ? "bg-destructive/10 text-destructive" : b.status === "confirmed" ? "bg-blue-500/10 text-blue-600" : "bg-orange-500/10 text-orange-600"}`,
					...
					}, b.id)), bookings.length === 0 && /* @__PURE__ */ jsx("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					}), todaysCheckins.length > 0 ? /* @__PURE__ */ jsx("div", {
						className: "flex flex-col gap-2",
						children: todaysCheckins.map((b) => /* @__PURE__ */ jsx("div", {
					...
					}), todaysCheckouts.length > 0 ? /* @__PURE__ */ jsx("div", {
						className: "flex flex-col gap-2",
						children: todaysCheckouts.map((b) => /* @__PURE__ */ jsx("div", {
							className: "p-2 bg-secondary rounded-lg text-[12px] font-medium truncate",
							children: b.guestName
						}, b.id))
					}) : /* @__PURE__ */ jsx("div", {
