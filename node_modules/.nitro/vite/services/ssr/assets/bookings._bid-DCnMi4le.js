import { n as getHostel } from "./hostels-DF_pzQ4E.js";
import { t as Route } from "./bookings._bid-mrEVMd0i.js";
import { n as MobileFrame, t as Icon } from "./MobileFrame-u4Sg7FL7.js";
import { n as formatCurrency, r as useBookings } from "./store-DX9pURiM.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/routes/bookings.$bid.tsx?tsr-split=component
function BookingDetail() {
	const { bid } = Route.useParams();
	const [bookings, setBookings] = useBookings();
	const b = bookings.find((x) => x.id === bid);
	if (!b) return /* @__PURE__ */ jsx(MobileFrame, { children: /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(MobileFrame, { children: [
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx(Link, {
				...
				children: "Done"
			}), b.status === "upcoming" && /* @__PURE__ */ jsx("button", {
