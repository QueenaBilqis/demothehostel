...
//#region src/routes/hostels.index.tsx?tsr-split=component
function HostelsList() {
	...
	return /* @__PURE__ */ jsxs(MobileFrame, { children: [/* @__PURE__ */ jsxs("header", {
		...
		}) : filtered.map((h) => /* @__PURE__ */ jsx(HostelCard, { h }, h.id))
	})] });
}
//#endregion
